 ...
 *  
 */
public abstract class IndexUris  extends Mapper<LongWritable , Text, Text, Text>{
	Log log = LogFactory.getLog(IndexUris.class);

	DocumentMaker docMaker;	
	SolrServer solrServer;
	LinkedDataService dataSource;

    /**
     * implementations must provide a linked data source. 
     */
    protected abstract LinkedDataService setupLinkedDataSource(org.apache.hadoop.mapreduce.Mapper.Context context);

    /**
     * Implementations may override this method to prvoide a specialized Document Maker.
     */
    protected DocumentMaker setupDocMaker(
            org.apache.hadoop.mapreduce.Mapper.Context context) {
        return new DocumentMakerImpl();        
    }

    protected SolrServer setupSolrServer(org.apache.hadoop.mapreduce.Mapper.Context context){
    ...
    protected void setup(Context context) throws IOException,
	    ...
	    this.docMaker   = setupDocMaker(context);
	    this.solrServer = setupSolrServer(context);
	    this.dataSource = setupLinkedDataSource(context);
    }
